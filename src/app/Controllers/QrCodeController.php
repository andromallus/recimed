...
class QrCodeController extends BaseController
{
    ...
    public function generatePdf()
    {
        ...
        $html .= '<tr>';
        $html .= '<th > Nombre</th>';
        $html .= '<td > ' . $nombre . ' ' . ' ' . $primer_apellido . ' ' . $segundo_apellido . '</td>';
        $html .= '<th > Edad</th>';
        $html .= '<td > ' . $edad . '</td>';
        $html .= '</tr>';
        $html .= '<p>';
    ...
    public function generatePdfS()
    {
        ...
        $html = '
        <div style="position: absolute; width: 100%; height: 100%; background-color: #f2f2f2; text-align: center;">
            <h1 style="margin-top: 40%;font-size:45px;">SURTIDA</h1>
        </div>';
        $pdf->writeHTML($html, true, false, true, false, '');
